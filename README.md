...
- `tag`: The tag to uploaded into. If you want the current event's tag, use `${{ github.ref }}`. If a release cannot be found, it will be created.
...
Optional Arguments
 ...
 - `draft`: When creating a release, make it a draft if set to true 
