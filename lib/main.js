...
function get_release_by_tag(tag, draft, octokit, context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (error.status === 404) {
                ...
                return yield octokit.repos.createRelease(Object.assign({}, context.repo, { tag_name: tag, draft: draft === 'true' }));
            }
            else {
                throw error;
            }
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const release = yield get_release_by_tag(tag, draft, octokit, context);
            if (file_glob === "true") {
